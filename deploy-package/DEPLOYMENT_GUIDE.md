...
- **Всех LLM моделей** (все 38 агентов)
...
- [ ] 38 agent файлов скопированы в `%USERPROFILE%\.config\opencode\agents\`
