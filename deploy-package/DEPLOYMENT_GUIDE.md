...
- **Всех LLM моделей** (все 35 агентов)
...
- [ ] 35 agent файлов скопированы в `%USERPROFILE%\.config\opencode\agents\`
